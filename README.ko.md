...
설정은 **일반**, **모양**, **표시 항목** 탭으로 구분되고 프리셋 3개는 모든 탭 위에 항상 표시됩니다. 스타일을 선택하면 해당 테마의 기본 배경색과 투명도도 함께 적용되며, 이후 원하는 값으로 다시 조절할 수 있습니다. 원형 게이지 스타일의 높이는 현재 모니터의 작업 표시줄 높이에 자동으로 맞춰집니다.
