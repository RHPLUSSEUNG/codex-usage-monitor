...
internal static class Localization
{
    private static readonly Dictionary<string, string[]> Strings = new(StringComparer.Ordinal)
    {
        ...
        ["CheckForUpdates"] = ["Check for updates", "업데이트 확인", "检查更新", "更新を確認"],
        ["CheckingForUpdates"] = ["Checking for updates…", "업데이트 확인 중…", "正在检查更新…", "更新を確認中…"],
        ["UpdateToVersion"] = ["Update to v{0}", "v{0}(으)로 업데이트", "更新到 v{0}", "v{0} に更新"],
        ["DownloadingUpdate"] = ["Downloading update…", "업데이트 다운로드 중…", "正在下载更新…", "更新をダウンロード中…"],
        ["UpdateAvailableTitle"] = ["Update available", "업데이트 사용 가능", "有可用更新", "更新があります"],
        ["UpdateAvailableMessage"] = ["Version {0} is available. Select “Update to v{0}” from the tray menu to install it.", "버전 {0}을 사용할 수 있습니다. 트레이 메뉴에서 ‘v{0}(으)로 업데이트’를 선택하면 설치됩니다.", "版本 {0} 已发布。请在托盘菜单中选择“更新到 v{0}”进行安装。", "バージョン {0} が利用できます。トレイメニューで「v{0} に更新」を選ぶとインストールされます。"],
        ["UpToDateTitle"] = ["No updates", "최신 버전", "没有更新", "更新はありません"],
        ["UpToDateMessage"] = ["Codex Usage Monitor is up to date.", "Codex Usage Monitor가 최신 버전입니다.", "Codex Usage Monitor 已是最新版本。", "Codex Usage Monitor は最新です。"],
        ["UpdateCheckFailed"] = ["Could not check for updates.", "업데이트를 확인하지 못했습니다.", "无法检查更新。", "更新を確認できませんでした。"],
        ["UpdateInstallFailed"] = ["Could not install the update.", "업데이트를 설치하지 못했습니다.", "无法安装更新。", "更新をインストールできませんでした。"],
